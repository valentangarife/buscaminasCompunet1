...
set CLASSPATH=%APP_HOME%\lib\client.jar;%APP_HOME%\lib\gson-2.10.1.jar


@rem Execute client
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLIENT_OPTS%  -classpath "%CLASSPATH%" co.icesi.buscaminas.client.MainClient %*
